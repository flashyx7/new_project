    ...
    try:
        ...
        if person_count == 0:
            ...
            cursor.execute("""
                ...
                VALUES 
                (2, 1, 'I am very interested in this software engineer position. I have 3 years of experience in Python and web development.', 1, 'resumes/john_candidate_resume.pdf'),
                (2, 2, 'I would love to work as a frontend developer. I have experience with React and modern JavaScript frameworks.', 2, 'resumes/john_candidate_resume2.pdf')
            """)
